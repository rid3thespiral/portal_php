    ...
    <div class="container">
    	...
    	<div class="row">
    	    ...
    	    <div class="col-xs-12">
				...
				<h1 id="intro">Benvenuta <?php echo '<p name="message">'.$_SESSION['username'].'!</p>'; ?></h1>
                <h1>Accedi ai tuoi servizi: </h1>
				<div class="centerer">
				<div class="wrap">
				<a class="btn-6" href="#">Funzione1<span></span></a>
				<a class="btn-6" href="#">Funzione2<span></span></a>
				<a class="btn-6" href="#">Funzione3<span></span></a>
				</div>
				</div>
